...
;(function(a) {
    ...
    var d, e, f, g, h, i, j, k, l, m, n = "", o = document.createElement("div"), p = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, q = {};
    o.style.transform === void 0 && a.each({
        Webkit: "webkit",
        Moz: "",
        O: "o"
    }, function(a, b) {
        if (void 0 !== o.style[a + "TransitionProperty"])
            return n = "-" + a.toLowerCase() + "-",
            d = b,
            !1
    }),
    e = n + "transform",
    q[f = n + "transition-property"] = q[g = n + "transition-duration"] = q[i = n + "transition-delay"] = q[h = n + "transition-timing-function"] = q[j = n + "animation-name"] = q[k = n + "animation-duration"] = q[m = n + "animation-delay"] = q[l = n + "animation-timing-function"] = "",
    a.fx = {
    ...
    a.fn.animate = function(b, c, d, e, f) {
        return a.isFunction(c) && (e = c,
        d = void 0,
        c = void 0),
        a.isFunction(d) && (e = d,
        d = void 0),
        a.isPlainObject(c) && (d = c.easing,
        e = c.complete,
        f = c.delay,
        c = c.duration),
    ...
    a.fn.anim = function(c, d, n, o, r) {
        var s, t, u, v = {}, w = "", x = this, y = a.fx.transitionEnd, z = !1;
        if (void 0 === d && (d = a.fx.speeds._default / 1e3),
        void 0 === r && (r = 0),
        a.fx.off && (d = 0),
        "string" == typeof c)
            v[j] = c,
            ...
            for (s in t = [],
            c)
                p.test(s) ? w += s + "(" + c[s] + ") " : (v[s] = c[s],
                t.push(b(s)));
            w && (v[e] = w,
            t.push(e)),
            0 < d && "object" == typeof c && (v[f] = t.join(", "),
            v[g] = d + "s",
            v[i] = r + "s",
            v[h] = n || "linear")
        }
...
;(function(a) {
    function b(b, c, d, e, f) {
        "function" != typeof c || f || (f = c,
        c = void 0);
        var g = {
            opacity: d
        };
        return e && (g.scale = e,
        b.css(a.fx.cssPrefix + "transform-origin", "0 0")),
        b.animate(g, c, null, f)
    }
    function c(c, d, e, g) {
    ...
    a.fn.fadeIn = function(a, b) {
        ...
        return 0 < c ? this.css("opacity", 0) : c = 1,
...
(function(d) {
    function k(b) {
        var c = [["resolve", "done", d.Callbacks({
            once: 1,
            memory: 1
        }), "resolved"], ["reject", "fail", d.Callbacks({
            once: 1,
            memory: 1
        }), "rejected"], ["notify", "progress", d.Callbacks({
            memory: 1
        })]]
          , g = "pending"
          , f = {
    ...
    d.when = function(b) {
        var c = p.call(arguments), g = c.length, f = 0, a = 1 !== g || b && d.isFunction(b.promise) ? g : 0, h = 1 === a ? b : k(), e, m, l, n = function(c, d, b) {
            return function(f) {
                d[c] = this;
        ...
        if (1 < g)
            ...
            m = Array(g),
            l = Array(g); f < g; ++f)
                c[f] && d.isFunction(c[f].promise) ? c[f].promise().done(n(f, l, c)).fail(h.reject).progress(n(f, m, e)) : --a;
        a || h.resolveWith(l, c);
        return h.promise()
    }
    ;
...
(function(f) {
    f.Callbacks = function(g) {
        g = f.extend({}, g);
        var e, n, l, p, h, k, a = [], c = !g.once && [], q = function(b) {
            e = g.memory && b;
            n = !0;
            k = p || 0;
            p = 0;
...
(function(d, m) {
    function e(a, b, c, f, e) {
        "function" != typeof b || e || (e = b,
        b = void 0);
        c = {
            opacity: c
        };
        f && (c.scale = f,
        a.css(d.fx.cssPrefix + "transform-origin", "0 0"));
...
$.fn.scrollTo = function(a) {
    var b = Math.round
      ...
      , j = function(a) {
        h++;
        var j = b(g / i);
        return h >= i ? (e.scrollTop(a),
        window.clearInterval(d),
        void (c.callback && "function" == typeof c.callback && c.callback())) : void e.scrollTop(f + h * j)
    };
